...
@Repository
@Transactional
public class AuditoriaPasfDAOCustomImpl implements AuditoriaPasfDAOCustom {
	...
	public Page<AuditoriaPasf> findAuditoriaPasfByPasf(String idPasf, PageRequest pageRequest) {
		...
		CriteriaQuery<AuditoriaPasf> cr = cb.createQuery(AuditoriaPasf.class);
		Root<AuditoriaPasf> root = cr.from(AuditoriaPasf.class);
		...
		TypedQuery<AuditoriaPasf> query = entityManager.createQuery(cr);
		List<AuditoriaPasf> result = query.setFirstResult((int) pageRequest.getOffset())
				.setMaxResults(pageRequest.getPageSize()).getResultList();

		CriteriaQuery<Long> countQuery = cb.createQuery(Long.class);
		Root<AuditoriaPasf> countRoot = countQuery.from(AuditoriaPasf.class);
